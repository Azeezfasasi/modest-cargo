  ...
  return (
    <article className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <Link href="/blog" className="text-red-700 hover:text-red-900 mb-4 inline-block">
            ← Back to blogs
          </Link>
          <h1 className="text-[26px] md:text-5xl font-bold text-gray-900 mb-4">{blog.postTitle}</h1>
          
          <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-6">
            <span className="text-sm font-semibold text-red-700 uppercase">{blog.category}</span>-
              ...
              <div className="flex gap-4 mb-4">
                <div className="w-10 h-10 rounded-full overflow-hidden bg-gray-200 shrink-0">
                  {user.avatar ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-red-700 text-white font-bold">
                ...
                <div className="flex-1">
                  ...
                  <textarea
                    ...
                    className="w-full mt-2 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-700 resize-none"
                    rows="4"
                  ...
                  <button
                    ...
                    className="mt-3 px-6 py-2 bg-red-700 text-white rounded-lg hover:bg-red-800 disabled:opacity-50 disabled:cursor-not-allowed transition font-medium cursor-pointer"
                  >
                ...
                <div key={comment._id} className="flex gap-4">
                  <div className="w-10 h-10 rounded-full overflow-hidden bg-gray-200 shrink-0">
                    {comment.userAvatar ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-red-700 text-white font-bold text-sm">
