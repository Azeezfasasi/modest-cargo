    ...
    <div className="space-y-6 w-fit lg:w-full">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between">
        ...
        <Link
          ...
          className="px-4 py-2 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 transition-colors flex items-center space-x-2 mt-4 lg:mt-0"
        >
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
          ...
          <Link
            href="/dashboard/send-newsletter"
            className="mt-4 inline-block px-4 py-2 text-red-600 hover:text-red-700 font-medium"
          >
