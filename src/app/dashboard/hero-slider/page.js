...
export default function HeroSliderManager() {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      const result = await uploadImageToCloudinary(file, 'modest/hero-slider');
      
      // Handle both string URL and object responses
            ...
            <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
              <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">
                      Slide Image * {imageUploading && <span className="text-red-600">(Uploading...)</span>}
                    </label>
