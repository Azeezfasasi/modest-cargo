    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 sm:py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <button
            onClick={() => router.back()}
            className="inline-flex items-center gap-2 text-red-700 hover:text-red-600 mb-8 font-medium"
          >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 sm:py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button
          onClick={() => router.back()}
          className="inline-flex items-center gap-2 text-red-700 hover:text-red-600 mb-6 sm:mb-8 font-medium"
        >
          <ArrowLeft className="h-5 w-5" />
          Back
        </button>
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-4 sm:mb-6">
              <div className="flex items-start justify-between gap-3 mb-4">
                <div>
                  ...
                  {categoryLabel && (
                    <span className="inline-block bg-red-100 text-red-700 text-xs sm:text-sm px-3 py-1 rounded-full font-medium">
                      {categoryLabel}
                    </span>
                  )}
                </div>
                ...
                <div className="space-y-3">
                  {gallery.businessName && (
                    <div className="flex items-start gap-3">
                      <Building2 className="h-5 w-5 text-red-700 shrink-0 mt-0.5" />
                      <div>
        ...
        <div className="mt-12 sm:mt-16">
          ...
          <button
            onClick={() => router.push('/gallery')}
            className="inline-block bg-red-900 text-white px-6 sm:px-8 py-3 rounded-lg font-medium hover:bg-red-800 transition-colors"
          >
            View All Galleries →
          </button>
        </div>
