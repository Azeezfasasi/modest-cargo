  ...
  try {
    ...
    try {
      const emailResult = await sendEmailViaBrevo({
        to: email,
        subject: 'Welcome to Modest Cargo Newsletter',
        htmlContent: `
          <!DOCTYPE html>
          <html>
            <head>
            ...
            <body>
              <div class="container">
                <div class="header">
                  <h1>Welcome to Modest Cargo Newsletter!</h1>
                </div>
                <div class="content">
                  <p>Hi ${firstName || 'there'},</p>
                  <p>Thank you for subscribing to our newsletter! We're excited to share the latest updates, insights, and innovations from Modest Cargo.</p>
                  <p>You'll receive:</p>
                  <ul>
                  ...
                  <p>Best regards,<br/>The Modest Cargo Team</p>
                </div>
                <div class="footer">
                  <p>© 2025 Modest Cargo. All rights reserved.</p>
        ...
        `,
        textContent: `Welcome to Modest Cargo Newsletter!

Hi ${firstName || 'there'},

Thank you for subscribing to our newsletter! We're excited to share the latest updates, insights, and innovations from Modest Cargo.
You'll receive:
