    ...
    <section className="relative bg-blue-900 text-white py-16 overflow-hidden">
      ...
      <div className="relative container mx-auto px-6 lg:px-20 text-center">
        ...
        <p className="text-blue-100 max-w-2xl mx-auto mb-8">
          Partner with <span className="font-semibold">Modest Cargo</span> for innovative, reliable, and cost-effective engineering solutions. Let&apo;s bring your ideas to life, on time and within budget.
        </p>
