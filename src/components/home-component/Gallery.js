      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 sm:mb-12">
          ...
          <p className="text-gray-600 text-sm sm:text-base lg:text-lg max-w-2xl">
            Explore a curated collection of Modest cargo shipments and logistics galleries showcasing our expertise and commitment to excellence.
          </p>
        </div>
        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-700 focus:border-transparent"
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <div className="relative flex-1">
              <select
                ...
                className="w-full px-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-700 focus:border-transparent appearance-none pr-10"
              >
                {CATEGORIES.map(cat => (
        ...
        {filteredGalleries.length > 0 ? (
                  ...
                  <Link href={`/gallery/${gallery._id}`} key={gallery._id}>
                    <div className="group bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden cursor-pointer h-full flex flex-col">
                      ...
                      <div className="p-3 sm:p-4 flex flex-col grow">
                        <h3 className="font-bold text-sm sm:text-base text-gray-900 mb-1 line-clamp-2 group-hover:text-red-700">
                          {gallery.title}
                        </h3>

                        {/* Category Badge */}
                        <div className="mb-2 sm:mb-3">
                          <span className="inline-block bg-red-50 text-red-700 text-xs px-2 py-0.5 rounded-full">
                            {gallery.category}
                          </span>
                        </div>
                        ...
                        <div className="space-y-1.5 sm:space-y-2 mt-auto text-xs sm:text-sm">
                          {gallery.businessName && (
                            <div className="flex items-center gap-2 text-gray-700">
                              <Building2 className="h-4 w-4 shrink-0 text-red-700" />
                    ...
                    <div className="group bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-300 p-4 sm:p-5 cursor-pointer flex gap-4 sm:gap-6">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2 mb-2">
                          <div>
                            <h3 className="font-bold text-sm sm:text-base text-gray-900 group-hover:text-red-700 truncate">
                              {gallery.title}
                            </h3>
                            <div className="flex items-center gap-2 mt-1">
                              <span className="inline-block bg-red-50 text-red-700 text-xs px-2 py-0.5 rounded capitalize">
                                {gallery.category}
                              </span>
                              {gallery.featured && (
          ...
          <div className="text-center py-12 sm:py-16">
            ...
            <button
              ...
              className="inline-block bg-red-900 text-white px-6 py-2 rounded-lg hover:bg-red-800 transition-colors text-sm font-medium"
            >
              Reset Filters
            </button>
          </div>
