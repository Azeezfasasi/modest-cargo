...
export default function SubscribeToNewsletter() {
  ...
  return (
    <div className="w-full py-16 bg-gradient-to-r from-red-50 via-white to-red-50">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="John"
                  disabled={isLoading}
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-700 focus:border-transparent transition-all disabled:bg-gray-50 disabled:cursor-not-allowed text-gray-900 placeholder-gray-500"
                />
              </div>
